Below is a **clean, ready-to-paste README description** based **strictly on the code you shared**. You can use it directly in your project.
...
* 🔒 Secure table name validation
* 🗄️ MySQL integration via SQLAlchemy
* ♻️ Idempotent inserts (avoids duplicate primary keys)
